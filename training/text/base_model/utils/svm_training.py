...
class TrainingClass():
    ...
    def train(self, balance_opt, pca_opt, scale_opt, comb_opt, c, loss, with_weight, return_preds=False):
        ...
        # filter column including binaries for balancing option
        ...
        if pca_opt != 'no_pca':
            ...
            # calculate number of dimensions to be selected as current dimensionality * ratio
