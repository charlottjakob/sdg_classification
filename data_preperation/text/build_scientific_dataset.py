...
import pandas as pd
import os
#from data_preperation.text.utils.sdg_description import sdg_short_description
...
def combine_training_data(nosdg_data_included):
    ...
    scholar_data['data_origin'] = 'paper abstract'
    scholar_data = scholar_data[['sdg', 'abstract', 'data_origin']].rename(columns={'abstract': 'text'})

    # load un_data
    un_data = load_un_data()
    un_data['data_origin'] = 'un website'
    ...
    if nosdg_data_included:
        ...
        wiki_data['data_origin'] = 'wikipedia article'
